...
local hlgroups = {
  ...
  CursorLineNr = { fg = c_orange, bold = false },
  ...
  Search = { bg = c_thunder },
  IncSearch = { fg = c_black, bg = c_orange, bold = false },
  ...
  MatchParen = { bg = c_thunder, bold = false },
  NonText = { fg = c_steel },
  ...
  Ignore = { fg = c_iron },
  Error = { fg = c_scarlet },
  Todo = { fg = c_black, bg = c_beige, bold = false },
  -- }}}2
  ...
  ['@markup.emphasis'] = { fg = c_beige, bold = false, italic = false, },
  ...
  htmlArg = { fg = c_pigeon },
  htmlBold = { bold = false },
  htmlBoldItalic = { bold = false, italic = false },
  htmlTag = { fg = c_smoke },
  htmlTagName = { link = 'Tag' },
  htmlSpecialTagName = { fg = c_yellow },
  htmlEndTag = { fg = c_yellow },
  htmlH1 = { fg = c_yellow, bold = false },
  htmlH2 = { fg = c_ochre, bold = false },
  htmlH3 = { fg = c_pink, bold = false },
  htmlH4 = { fg = c_lavender, bold = false },
  htmlH5 = { fg = c_cerulean, bold = false },
  htmlH6 = { fg = c_aqua, bold = false },
  ...
  -- Markdown
  markdownBold = { fg = c_aqua, bold = false },
  markdownBoldItalic = { fg = c_skyblue, bold = false, italic = false },
  ...
  -- Checkhealth
  helpHeader = { fg = c_pigeon, bold = false },
  helpSectionDelim = { fg = c_ochre, bold = false },
  helpCommand = { fg = c_turquoise },
  helpBacktick = { fg = c_turquoise },

  -- Man
  manBold = { fg = c_ochre, bold = false },
  manItalic = { fg = c_turquoise, italic = false },
  ...
  CmpItemAbbrMatch = { fg = c_white, bold = false },
  ...
  CmpVirtualText = { fg = c_steel, italic = false },
  ...
  fugitiveHeading = { fg = c_orange, bold = false },
  fugitiveHelpTag = { fg = c_orange },
  fugitiveSymbolicRef = { fg = c_yellow },
  fugitiveStagedModifier = { fg = c_tea, bold = false },
  fugitiveUnstagedModifier = { fg = c_scarlet, bold = false },
  fugitiveUntrackedModifier = { fg = c_pigeon, bold = false },
  fugitiveStagedHeading = { fg = c_aqua, bold = false },
  fugitiveUnstagedHeading = { fg = c_ochre, bold = false },
  fugitiveUntrackedHeading = { fg = c_lavender, bold = false },

  -- telescope
  TelescopeNormal = { link = 'NormalFloat' },
  TelescopePromptNormal = { bg = c_jeans },
  TelescopeTitle = { fg = c_space, bg = c_turquoise, bold = false },
  TelescopePromptTitle = { fg = c_space, bg = c_yellow, bold = false, },
  TelescopeBorder = { fg = c_smoke, bg = c_jeans },
  TelescopePromptBorder = { fg = c_smoke, bg = c_jeans },
  TelescopeSelection = { fg = c_smoke, bg = c_thunder },
  TelescopeMultiIcon = { fg = c_pigeon, bold = false },
  TelescopeMultiSelection = { bg = c_thunder, bold = false },
  ...
  texMathStyleBold = { fg = c_smoke, bold = false },
  texMathStyleItal = { fg = c_smoke, italic = false },
  ...
  texMathCmdStyleBold = { fg = c_yellow, bold = false },
  texMathCmdStyleItal = { fg = c_yellow, italic = false },
  ...
  LazyButtonActive = { bg = c_thunder, bold = false },
  LazyH1 = { fg = c_space, bg = c_yellow, bold = false },

  -- copilot.lua
  CopilotSuggestion = { fg = c_steel, italic = false },
  CopilotAnnotation = { fg = c_steel, italic = false },
